# Atoms Demo — 项目说明（面试自述）

> **说明**：本项目受官方 [Atoms](https://atoms.dev/) 公开产品体验启发，是我独立实现的演示仓库，与 atoms.dev 无关联。  
> 我对 Atoms 的了解来自其官网与公开演示，**并未参与官方产品开发**；下文关于 Atoms 的对比，仅指我从外部观察到的产品能力，不代表其内部实现细节。
...
### 2.2 相对 Atoms，我 deliberate 做的取舍

| 维度 | 我观察到的 Atoms（产品层） | 本项目的做法 | 我为什么这样选 |
|------|---------------------------|--------------|----------------|
| **部署** | 托管 SaaS + 应用级 Cloud | 自托管 Next + FastAPI + 自管 PostgreSQL | 面试/Demo 场景要能本地改流水线、看日志，不绑专有云 |
